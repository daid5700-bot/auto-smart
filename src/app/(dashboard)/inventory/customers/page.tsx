      ...
      <div className="flex items-center justify-between pb-5 border-b border-border flex-wrap gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-2 font-medium">
            Quản lý thông tin khách mua phụ tùng và theo dõi công nợ chi tiết.
          </p>
        </div>
      </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-[10px] text-muted-foreground mt-2 font-medium">
                    Nhập đúng tổng số tiền khách đã đóng cho đơn hàng này. Phần nợ sẽ được hệ thống tự tính lại.
                  </p>
                </div>

        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch("/api/crm?tab=zns")];
                case 1:
                    res = _a.sent();
      ...
      <div className="glass-card rounded-xl overflow-hidden">
        <table className="data-table">
          ...
          <tbody>
            ...
            var _a;
            return (<tr key={l.id}>
                <td className="text-muted-foreground text-xs">{(0, utils_1.formatDate)(l.sentAt)}</td>
                <td className="font-semibold">{(_a = l.customer) === null || _a === void 0 ? void 0 : _a.name}</td>
                <td>{l.phone}</td>
                ...
                <td>
                  <span className="inline-flex items-center gap-1 text-xs font-bold text-success bg-success/15 px-2 py-0.5 rounded-full">
                    <lucide_react_1.CheckCircle2 size={12}/> Đã gửi (Sent)
                  </span>
                </td>
              </tr>);
        })}

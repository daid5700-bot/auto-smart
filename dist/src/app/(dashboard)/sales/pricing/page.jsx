...
exports.default = VehiclePricingPage;
var react_1 = require("react");
var utils_1 = require("@/lib/utils");
var lucide_react_1 = require("lucide-react");
function VehiclePricingPage() {
    var _this = this;
    ...
    // Form edit price
    var _d = (0, react_1.useState)(0), listPrice = _d[0], setListPrice = _d[1];
    var _e = (0, react_1.useState)(0), floorPrice = _e[0], setFloorPrice = _e[1];
    ...
    var handleStartEdit = function (v) {
        setEditingId(v.id);
        setListPrice(Number(v.listPrice));
        setFloorPrice(Number(v.floorPrice));
    };
    var handleSave = function (id) { return __awaiter(_this, void 0, void 0, function () {
        var res, e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch("/api/sales/".concat(id), {
                            ...
                            body: JSON.stringify({ listPrice: listPrice, floorPrice: floorPrice }),
                        })];
                case 1:
                    res = _a.sent();
        ...
        <table className="data-table">
          ...
          <tbody>
            ...
            return (<tr key={v.id}>
                  ...
                  <td>
                    {isEditing ? (<input type="number" value={floorPrice} onChange={function (e) { return setFloorPrice(parseInt(e.target.value) || 0); }} className="w-32 px-2 py-1 bg-secondary/30 border border-border rounded text-sm focus:ring-1 focus:ring-primary outline-none"/>) : (<span className="font-bold text-success">{(0, utils_1.formatCurrency)(Number(v.floorPrice))}</span>)}
                  </td>
                  <td>
                    {isEditing ? (<div className="flex gap-2">
                        <button onClick={function () { return handleSave(v.id); }} className="p-1.5 bg-success/10 text-success hover:bg-success/20 rounded"><lucide_react_1.Check size={14}/></button>
                      ...
                      </div>) : (<button onClick={function () { return handleStartEdit(v); }} className="p-1.5 hover:bg-secondary rounded text-primary flex items-center gap-1 text-xs font-semibold"><lucide_react_1.Edit size={12}/> Đổi giá</button>)}
                  </td>
                </tr>);
        })}
          </tbody>

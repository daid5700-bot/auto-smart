...
function PATCH(req_1, _a) {
    return __awaiter(this, arguments, void 0, function (req, _b) {
        var id, body, product, _i, _c, p, error_1;
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    product = _d.sent();
                    if (!(body.prices && Array.isArray(body.prices))) return [3 /*break*/, 6];
                    _i = 0, _c = body.prices;
                    _d.label = 3;
                case 3:
                    if (!(_i < _c.length)) return [3 /*break*/, 6];
                    p = _c[_i];
                    return [4 /*yield*/, prisma_1.prisma.price.upsert({
                            where: {
                ...
                case 5:
                    _i++;
                    return [3 /*break*/, 3];
                case 6: return [2 /*return*/, server_1.NextResponse.json(product)];
                case 7:
                    error_1 = _d.sent();
    ...
    return __awaiter(this, arguments, void 0, function (req, _b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _c.sent();
                    return [2 /*return*/, server_1.NextResponse.json({ success: true, message: "Xóa phụ tùng thành công" })];
                case 2:
                    error_2 = _c.sent();

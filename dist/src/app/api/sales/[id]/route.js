    ...
    return __awaiter(this, arguments, void 0, function (req, _b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    vehicle = _c.sent();
                    return [2 /*return*/, server_1.NextResponse.json(vehicle)];
                case 3:
                    error_1 = _c.sent();
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    id = parseInt(params.id);
                    return [4 /*yield*/, prisma_1.prisma.vehicle.delete({ where: { id: id } })];
                case 1:
                    _c.sent();
                    return [2 /*return*/, server_1.NextResponse.json({ success: true, message: "Xóa thông tin xe thành công" })];
                case 2:
                    error_2 = _c.sent();
